...
@Component({
  tag: 'photopay-in-browser',
  styleUrl: 'photopay-in-browser.scss',
  shadow: true,
})
export class PhotopayInBrowser implements MicroblinkUI {
   ...
   *
   * Available recognizers for PhotoPay:
   *
   ...
   *
   * `<photopay-in-browser recognizers="CroatiaPdf417PaymentRecognizer,CroatiaQrCodePaymentRecognizer"></photopay-in-browser>`
   */
   ...
   * photopay.recognizers = ['CroatiaPdf417PaymentRecognizer', 'CroatiaQrCodePaymentRecognizer'];
   * ```
   */
