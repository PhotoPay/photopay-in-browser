 ...
 */
export async function createSepaQrCodePaymentRecognizer( wasmSDK: WasmSDK ): Promise< SepaQrCodePaymentRecognizer >
{
    return wasmSDK.mbWasmModule.newRecognizer( "SepaQrCodePaymentRecognizer" ) as Promise< SepaQrCodePaymentRecognizer >;
}