 ...
 */
export async function createGermanyQrCodePaymentRecognizer( wasmSDK: WasmSDK ): Promise< GermanyQrCodePaymentRecognizer >
{
    return wasmSDK.mbWasmModule.newRecognizer( "GermanyQrCodePaymentRecognizer" ) as Promise< GermanyQrCodePaymentRecognizer >;
}